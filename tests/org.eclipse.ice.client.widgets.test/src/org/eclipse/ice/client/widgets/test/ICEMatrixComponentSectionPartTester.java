...
public class ICEMatrixComponentSectionPartTester {
	...
	public void checkMatrixComponent() {
		final MatrixComponent matrixComponent = new MatrixComponent();
		...
		// Assert the SectionParts reference to the MatrixComponent is
		// initially null
		...
		// Now verify it is not null and is the same as the one we just
		// gave it
		...
		// it does not get set as the SectionPart's MatrixComponent reference
